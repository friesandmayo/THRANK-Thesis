...
param_macro_name   = 'kappa_m_val'; % Must match the @#define variable in the .mod file
param_display_name = 'kappa_m';     
val_base           = 10.00;        % Baseline value
val_alt            = 0.00;         % Alternative value
