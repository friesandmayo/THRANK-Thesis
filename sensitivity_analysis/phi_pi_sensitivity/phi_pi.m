...
param_macro_name   = 'phi_pi_val'; % Must match the @#define variable in the .mod file
param_display_name = 'phi_pi';     
val_base           = 1.50;        % Baseline value
val_alt            = 2.50;         % Alternative value
