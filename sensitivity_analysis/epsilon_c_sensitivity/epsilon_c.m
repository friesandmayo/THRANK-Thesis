...
param_macro_name   = 'epsilon_c_val'; % Must match the @#define variable in the .mod file
param_display_name = 'epsilon_c';     
val_base           = 5.00;        % Baseline value
val_alt            = 3.00;         % Alternative value
