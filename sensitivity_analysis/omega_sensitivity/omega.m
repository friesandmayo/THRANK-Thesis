...
param_macro_name   = 'omega_val'; % Must match the @#define variable in the .mod file
param_display_name = 'omega';     
val_base           = 0.025;        % Baseline value
val_alt            = 0.25;         % Alternative value
