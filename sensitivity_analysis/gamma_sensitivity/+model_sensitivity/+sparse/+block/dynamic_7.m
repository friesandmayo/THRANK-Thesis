function [y, T] = dynamic_7(y, x, params, steady_state, sparse_rowval, sparse_colval, sparse_colptr, T)
  ...
  y(132)=y(76)^(1-params(8))/(1-params(8))+params(14)*y(80)^(1-params(9))/(1-params(9))-T(19)/(1+params(11));
  y(136)=y(81)^(1-params(8))/(1-params(8))+params(15)*y(83)^(1-params(10))/(1-params(10))-T(38)/(1+params(11));
end
