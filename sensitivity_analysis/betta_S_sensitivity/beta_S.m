...
param_macro_name   = 'betta_S_val'; % Must match the @#define variable in the .mod file
param_display_name = 'Beta_S';     
val_base           = 0.992;        % Baseline value
val_alt            = 0.985;         % Alternative value
