function [y, T] = dynamic_9(y, x, params, steady_state, sparse_rowval, sparse_colval, sparse_colptr, T)
  ...
  T(60)=params(1)*params(2)*(y(138)-y(134))+params(1)*params(3)*(y(142)-y(134))+params(2)*params(3)*(y(142)-y(138));
  y(149)=T(60)/(params(1)*y(134)+params(2)*y(138)+params(3)*y(142));
  ...
  y(131)=y(123)-y(121);
  y(150)=y(94)*T(13)+y(95)*y(122)*T(11)+y(99)+y(91)-y(97)+y(112)*y(124)-y(123)*(y(113)+y(79)*params(1))+y(99)*T(10);
end
