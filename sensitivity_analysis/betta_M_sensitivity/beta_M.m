...
param_macro_name   = 'betta_M_val'; % Must match the @#define variable in the .mod file
param_display_name = 'Beta_M';     
val_base           = 0.98;        % Baseline value
val_alt            = 0.972;         % Alternative value
