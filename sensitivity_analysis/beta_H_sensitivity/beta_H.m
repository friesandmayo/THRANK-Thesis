...
param_macro_name   = 'betta_H_val'; % Must match the @#define variable in the .mod file
param_display_name = 'Beta_H';     
val_base           = 0.97;        % Baseline value
val_alt            = 0.95;         % Alternative value
