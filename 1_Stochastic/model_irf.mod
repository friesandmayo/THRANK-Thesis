...
// This file here implements stochastic IRFs differences between a no-RFA and RFA economy
...
@#endif
@#ifndef varpi_val
    @#define varpi_val = 0.999999
@#endif
@#ifndef m_bar_val
    @#define m_bar_val = 100        
@#endif
@#ifndef tau_val
    @#define tau_val = 0
@#endif
...
sigma_xi   = 0.0025;             varpi  = @{varpi_val};   
...
// --------- Stochastic Shocks ---------
shocks;
  var varepsilon_z = sigma_z^2;
  var varepsilon_xi = sigma_xi^2;
end;
