...
PSI        = @{PSI_val};         alpha_L    = @{alpha_L_val};
...
tau_M      = @{tau_M_val};       omega      = @{omega_val}; 
kappa_m    = @{kappa_m_val};     kappa_d    = @{kappa_d_val};
epsilon_m  = @{epsilon_m_val};   epsilon_d  = @{epsilon_d_val};
i_bar      = 1/betta_S - 1;      phi_pi     = @{phi_pi_val};  
phi_f      = @{phi_f_val};       rho_z      = @{rho_z_val}; 
