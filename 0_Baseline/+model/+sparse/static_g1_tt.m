...
T(55) = getPowerDeriv(y(5)*x(3)/y(3),T(3),1);
T(56) = getPowerDeriv(y(5)*(1-x(3))/y(4),T(3),1);
...
T(62) = getPowerDeriv(x(3)*y(12)/y(10),T(3),1);
T(63) = getPowerDeriv((1-x(3))*y(12)/y(11),T(3),1);
T(64) = params(14)*getPowerDeriv(y(12),(-params(8)),1);
T(65) = getPowerDeriv(y(13),(-params(7)),1);
T(66) = y(54)*T(65);
T(67) = getPowerDeriv(T(21),T(8),1);
T(68) = getPowerDeriv(x(3)*y(21)/y(19),T(3),1);
T(69) = getPowerDeriv((1-x(3))*y(21)/y(20),T(3),1);
